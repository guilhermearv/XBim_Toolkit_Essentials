...
{
    public class ExcelSpaceReportFromIfcResource
    {
        public void GenerateExcel()
        {
            ...
            var workbook = new XSSFWorkbook(filePath + "template.xlsx");
            ...
            using (var model = IfcStore.Open(filePath + "SampleHouse.ifc"))
            {
            ...
            //save report
            using (var stream = File.Create(filePath + "spaces.xlsx"))
            {
        ...
        private void WriteSpaceRow(IIfcSpace space, ISheet sheet, ICellStyle areaStyle, ICellStyle volumeStyle)
        {
        ...
        private IIfcBuildingStorey GetFloor(IIfcSpace space)
        {
            return
